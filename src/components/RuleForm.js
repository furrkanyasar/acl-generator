...
import { ACTIONS, PROTOCOLS, ADDRESS_TYPES, getCommonPorts, getIcmpTypes, createDefaultRule } from '../core/types.js';
      ...
      <form id="rule-form">
        <div class="form-grid">
          ...
          <div class="form-group ${rule.srcType === ADDRESS_TYPES.ANY ? 'style-hidden' : ''}" id="src-ip-group">
            ...
            <input type="text" id="rule-src-ip" value="${rule.srcIp || ''}" placeholder="192.168.1.50" />
          </div>
          ...
          <div class="form-group ${rule.srcType !== ADDRESS_TYPES.SUBNET ? 'style-hidden' : ''}" id="src-mask-group">
            ...
            <input type="text" id="rule-src-mask" value="${rule.srcMask || ''}" placeholder="255.255.255.0 / 24" />
          ...
          ${isTcpOrUdp ? `
            ...
            <div class="form-group ${rule.srcPortOperator === 'any' ? 'style-hidden' : ''}" id="src-port-group">
              ...
              <div style="display:flex; gap:0.3rem;">
                <input type="text" id="rule-src-port" value="${rule.srcPort || ''}" placeholder="80" style="flex:1" />
          ...
          ${isExtended ? `
            ...
            <div class="form-group ${rule.dstType === ADDRESS_TYPES.ANY ? 'style-hidden' : ''}" id="dst-ip-group">
              ...
              <input type="text" id="rule-dst-ip" value="${rule.dstIp || ''}" placeholder="10.0.0.1" />
            </div>
            ...
            <div class="form-group ${rule.dstType !== ADDRESS_TYPES.SUBNET ? 'style-hidden' : ''}" id="dst-mask-group">
              ...
              <input type="text" id="rule-dst-mask" value="${rule.dstMask || ''}" placeholder="255.255.255.0 / 24" />
          ...
          ${isTcpOrUdp ? `
            ...
            <div class="form-group ${rule.dstPortOperator === 'any' ? 'style-hidden' : ''}" id="dst-port-group">
              ...
              <div style="display:flex; gap:0.3rem;">
                <input type="text" id="rule-dst-port" value="${rule.dstPort || ''}" placeholder="80" style="flex:1" />
          ...
          <div class="form-group full-width" style="display:flex; gap:1rem; align-items:center;">
            <div style="flex:1">
              ...
              <input type="text" id="rule-remark" value="${rule.remark || ''}" placeholder="Description / comment" />
            </div>
