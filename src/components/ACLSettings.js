...
import { ACL_TYPES } from '../core/types.js';
    ...
    <div class="card" style="flex-shrink: 0;">
      ...
      <div class="form-grid">
        ...
        <div class="form-group">
          ...
          <input type="text" id="acl-identifier" value="${config.identifier}" placeholder="MY_SECURE_ACL / 101" />
        </div>

        <div class="form-group">
          <label for="interface-name">${t('interfaceNameLabel')}</label>
          <input type="text" id="interface-name" value="${config.interfaceName || ''}" placeholder="GigabitEthernet0/0/1" />
        </div>
